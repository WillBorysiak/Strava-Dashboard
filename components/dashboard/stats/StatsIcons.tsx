...
export const elevationIcon = <FontAwesomeIcon icon={faMountains} size="2x" className="text-stone-200" />;
export const biggestIcon = <FontAwesomeIcon icon={faMedal} size="2x" className="text-stone-200" />;
